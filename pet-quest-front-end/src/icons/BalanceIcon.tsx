  ...
  path: (
    <>
      <path
        ...
        stroke="#000000" stroke-width="2" stroke-linecap="square" stroke-linejoin="round" fill="none"></path>
      <path
        ...
        stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"></path>
    </>
  )
})